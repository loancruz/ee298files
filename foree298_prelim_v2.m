...
repetitions = 3000; % change to 300000
...
save('aveber_snr0to15.mat','aveberml')
save('aveser_snr0to15.mat','aveserml')
save('aveier_snr0to15.mat','aveierml')
